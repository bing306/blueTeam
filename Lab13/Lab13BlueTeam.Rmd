...
realX <- mean(coal89$TOEperPerson)
realY <- mean(coal09$TOEperPerson)
...
```
The labels matter. The actual difference of means is much different from the random difference of means.