...
# Reflections:
##Team
As far as our Team goal, I would say we achieved them. We are all fluent in R markdown and have learned tons of data science tools. These are skills that we can use for the rest of our lives and will be great assets to us. We did really well on all of our Team tests, so we wouldn't change that, however one thing we could have done is get work done earlier so that we had less stress right before the deadline
