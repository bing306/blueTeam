...
We will each determine an award to give to a team. The team with the most awards is the best team. It is important that we use multiple different metrics to decide what team is the best because some teams are good at one thing while other teams are good at something else.
...
The improvement score is a weighted sum of the (normalized by number of games per season) difference between wins, runs, runs scored, doubles, tripples, homeruns, and errors committed for the 2018 season and the 1998 season. The most improved score goes to The Dodgers. Their improvement score is 30. All four awards will be used to determine the best team in the MLB.
