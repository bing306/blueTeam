...
Questions and answers that contain code both have higher scores than questions and answers that do not contain code. The difference is much larger in answers. Questions with code in them receive 6 more points on average than questions without code. Answers with code receive 14 more points on average than answers without code. So, if you want to have a question or an answer with a high score, include some code.
