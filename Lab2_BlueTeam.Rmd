...
- Also, I like to snowboard, hike, swim, and, as of recently, play poker.
    ...
    + (Ryan) Very answers are very detailed. I've also thought about moving to a different country including Germany.
    
    + (Nick) Your plans are laid out very clear and concse. I think your question is excellent as well, traffic is always something we should be improving. 

    + (Bing) Your interests are vast which is realy interesting. I also like to ski/snowboard and play poker.
...
- Something about me is I love to read on my off time with no specific genre in mind. Also i'm a competive gamer, while not profesional I do participate in a couple online tournaments and even in person tournaments. the one game I play the most is Leauge of Legendes
    ...
    + (Ryan) Your answers are complete and intersting. If I had more free time I would love to read more.
    
    + (Nick) Your writing is well thought out. Your question is interesting and I would imagine there are some great ways to view this data. Maybe mention which online games you like to be apart of. Starcraft? 

    + (Bing) I like that you are interested in going abroad and are learning another language. Gaming competitions are such awesome events.
...
- I am from Piedmont, California which is right next to Oakland. I am a Golden State Warriors fan and follow the NBA very closely.
    ...
    + (Ryan) I also love to travel and visit new places. I like how all of ours are formatted similarly. 
    
    + (Nick) Your statements are short and sweet. You might be interested to use data analysis for fantasy leagues. 
...
- I was born and raised here in colorado, and I dont think I'll ever want to live in a place without mountains.
    ...
    + (Ryan) I would also like to see that data about diseases. I think adding a photo would help us visualize what you look like.

    + (Bing) Have you ever thought about going into medical fields? I also agree that data science is only growing right now.
...
- I would like to see data on public opionions of climate change and how it changes with geography and other factors. 

- 6 months after graduating I want to find a job as a data scientist, although I'm nor exactly sure what field I'd like to specialize in.

- 5 years after graduating I want to be working remotely and traveling, not necesarily working free-lance but at least remotely.

- I hope my greatest career accomplishment will be being able to live and work in a van, so you could say I'm very ambitious. 

- I am hoping to learn what it means to be a data scientist and the ability to analzye data in any subject I want. 
    ...
    + (Nick) I like how all your statements here are somewhat connected to eachoter. And that sounds like quite the van.

    + (Bing) I like how you statements have similar structure. I also am not exactly sure what I want to do with data science.
