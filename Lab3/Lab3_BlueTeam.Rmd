...
I Brandon Bowen created a bar graph to show people with and without a health plan and the proportion of each health class in each section. To easily see the proportion I made the function "position = "fill". "  Then i used the "fill" function to classify my general health to make it easier to see. Based off the chart in the upper two catagories of health( Exccelent and very good) the proportion with a health plan is larger than the one without. In the lower three catagories the proportion is larger with those who don't have a health plan. Therefore i conclude that the proportion of heathy people is larger with those who have a health plan than those who don't. This can be attributed to the fact that people who are healthier most likely have some form of a health plan.
