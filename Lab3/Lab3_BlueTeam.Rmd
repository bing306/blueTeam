...
```
I Brandon Bowen, vreated a bar graph with the "fill" option in order to clearly lable the general health of people. Than use the position = fill function to better compare the two sides since the count is vastly different for the two bar charts. Based of the graph the two upper classes of general health has a higher porportion of people with health insurance, While the lower three classes of general health has a higher proportion with people without health insurance.
